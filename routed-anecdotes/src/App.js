...
const Menu = () => {
   return (
      <div className='paddingB'>
         <Link className='paddingR' to='/' >anecdotes</Link>
         <Link className='paddingR' to='/create' >create new</Link>
         <Link className='paddingR' to='/about' >about</Link>
      </div>
   )
}
...
const Anecdote = ({ anecdote }) => {
   ...
   return (
      <div key={anecdote.id} className='paddingB'>
         ...
         <div className='paddingT'>This anecdote has <strong>{anecdote.votes}</strong> votes</div>
      </div>
   )
}
